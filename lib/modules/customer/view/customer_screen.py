...
# sys.path.append('.\\lib\modules\customer\controller')
# sys.path.append('.\\lib\modules\customer\model')
...
# from customer_view import Ui_customer_tab
# from customer_card import Ui_customer_card
...
#         self.controller.signalSelectCustomer.connect(self.showDetail)
#         self.ui = Ui_customer_tab()
