...
"background-color: rgb(218, 221, 225);")
        ...
        self.frame_2 = QtWidgets.QFrame(self.list_product)
        ...
        self.list_staff_label = QtWidgets.QLabel(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.horizontalLayout_5.addWidget(self.list_staff_label)
        self.button_refresh = QtWidgets.QPushButton(self.frame_2)
        self.button_refresh.setMinimumSize(QtCore.QSize(0, 25))
        self.button_refresh.setMaximumSize(QtCore.QSize(80, 16777215))
        self.button_refresh.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:20px;\n"
"")
...
"background-color: rgb(79, 79, 79);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 320, 439))
        font = QtGui.QFont()
        font.setPointSize(5)
...
"background-color: rgb(218, 221, 225);")
        ...
        self.action_option = QtWidgets.QWidget(self.edit_view)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.button_add = QtWidgets.QPushButton(self.action_option)
...
"border-radius: 5px;")
        ...
        self.button_edit = QtWidgets.QPushButton(self.action_option)
...
"border-radius: 5px;")
        ...
        self.button_delete = QtWidgets.QPushButton(self.action_option)
...
"border-radius: 5px;")
        ...
        self.view_section = QtWidgets.QWidget(self.edit_view)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(10)
        sizePolicy.setHeightForWidth(self.view_section.sizePolicy().hasHeightForWidth())
        self.view_section.setSizePolicy(sizePolicy)
        self.view_section.setObjectName("view_section")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.view_section)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.stackedWidget = QtWidgets.QStackedWidget(self.view_section)
        self.stackedWidget.setObjectName("stackedWidget")
        self.detail_page = QtWidgets.QWidget()
        self.detail_page.setObjectName("detail_page")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.detail_page)
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.detail_form = QtWidgets.QFormLayout()
        self.detail_form.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.detail_form.setContentsMargins(-1, -1, -1, 10)
        self.detail_form.setSpacing(10)
        self.detail_form.setObjectName("detail_form")
        self.cus_label = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.cus_label.setFont(font)
        self.cus_label.setObjectName("cus_label")
        self.detail_form.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.cus_label)
        self.cus_ct = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.detail_form.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cus_ct)
        self.staff_label = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.staff_label.setFont(font)
        self.staff_label.setObjectName("staff_label")
        self.detail_form.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.staff_label)
        self.staff_ct = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.detail_form.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.staff_ct)
        self.pay_lb = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.pay_lb.setFont(font)
        self.pay_lb.setObjectName("pay_lb")
        self.detail_form.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.pay_lb)
        self.pay_ct = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.pay_ct.setFont(font)
        self.pay_ct.setText("")
        self.pay_ct.setObjectName("pay_ct")
        self.detail_form.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.pay_ct)
        self.total_lb = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.total_lb.setFont(font)
        self.total_lb.setObjectName("total_lb")
        self.detail_form.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.total_lb)
        self.total_ct = QtWidgets.QLabel(self.detail_page)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.detail_form.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.total_ct)
        self.verticalLayout_6.addLayout(self.detail_form)
        self.frame_4 = QtWidgets.QFrame(self.detail_page)
...
"")
        ...
        self.frame_3 = QtWidgets.QFrame(self.detail_page)
...
"")
        ...
        self.detailPage_listProd = QtWidgets.QVBoxLayout(self.frame_3)
        self.detailPage_listProd.setContentsMargins(0, 10, 0, 10)
        self.detailPage_listProd.setSpacing(10)
        self.detailPage_listProd.setObjectName("detailPage_listProd")
...
"")
        ...
        self.verticalLayout.addWidget(self.view_section)
...
"background-color: rgb(79, 79, 79);")
    ...
    def retranslateUi(self, invoice):
        ...
        self.button_refresh.setText(_translate("invoice", "Refresh"))
        ...
        self.cus_label.setText(_translate("invoice", "Khách hàng"))
        self.staff_label.setText(_translate("invoice", "Nhân viên"))
        self.pay_lb.setText(_translate("invoice", "Thanh toán"))
        self.total_lb.setText(_translate("invoice", "Tổng tiền"))
        self.label.setText(_translate("invoice", "Sản phẩm"))
        self.label_3.setText(_translate("invoice", "Số lượng"))
        self.label_5.setText(_translate("invoice", "Thành tiền"))
